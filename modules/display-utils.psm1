<#
.SYNOPSIS
  Enhanced display utilities like ls, tree, and date.
#>

function Get-EnhancedChildItem {
    param([string]$Path = ".", [switch]$l, [switch]$a, [switch]$h)
    $force = [bool]$a
    if ($l -or $h) {
        Get-ChildItem -Path $Path -Force:$force | Format-Table -AutoSize
    } else {
        Get-ChildItem -Path $Path -Force:$force | Format-Wide -AutoSize
    }
}
Set-Alias ls Get-EnhancedChildItem -Option AllScope -Force
...
function Get-Tree {
    ...
    Get-ChildItem -Path $Path -Recurse -ErrorAction SilentlyContinue |
        ...
        ForEach-Object { $_.Replace($Path, "").TrimStart('\') }
}
Set-Alias tree Get-Tree -Option AllScope -Force

function Get-DateEnhanced {
    param([string]$Format = "")
    if ($Format) { Get-Date -Format $Format } else { Get-Date }
}
Set-Alias date Get-DateEnhanced -Option AllScope -Force

function clear-enhanced {
    if ($Host.Name -eq 'ConsoleHost') { [System.Console]::Clear() } else { Clear-Host }
}
Set-Alias clear clear-enhanced -Option AllScope -Force


# SIG # Begin signature block
# MIIb5gYJKoZIhvcNAQcCoIIb1zCCG9MCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoOY0tDeHjecAAwvYVZ39WSB7
# oTSgghZQMIIDEjCCAfqgAwIBAgIQdAYnD4MYrLRGhujoNt/icTANBgkqhkiG9w0B
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRVjluzNisk
# QwU34/5ltwqfFPRRNjANBgkqhkiG9w0BAQEFAASCAQDbrpqVSbYMeL4scuGeIllk
# sHzjvPnSUNWwzTjyf9W6ih5P38od2uzPfoCSoyM+umt+yj4krxVmlDBc9pYrz1as
# BwGk+tLjlSXCrc+Mi7ZIFjbwhoS+QyOYi0zi/8nh/sXfdGiGrdML6PxAFr82/U+r
# X59aS+9bI2zwi0WJ9RTsuv9s7WupTf+mvkNjtdQ8sTa1j+ya9UUVZVJINlucCJkB
# 1CEQa+ZnbbZn2XT/rllwFpJhizm1y33AzzbMxxtr7JryCG88Yl5S9Aq6fsdHWHQS
# HPhk1ZkeII9NqGJSnJvYBmDUKP16yOq7Dwr6ujoMrhkUmkIWg9ish3ozOPZZigY0
...
# AQkEMSIEIBjaOEOkdtGI/H8Q5WSdNcvwXKjZ6bA+Dnn64uZDKajQMA0GCSqGSIb3
# DQEBAQUABIICALqA8T/XiZkTwF72IEmN1bRniTPSCgE96+iPhmFNcYHwBAuykzVU
# HV4AZl1zOT73avD3chIykUTOQ77oC6iP0g0MYMswGY+xnJHye31/3IxAYPtYFV6T
# BVPpG3x3yfsJpmHmoWBUQtL+XT7lidsycwajNVLx0y4P3UlJavyilE4TBebEP0ja
# m45/Wy5zXxXegrvTl7VMJodExoizyG+s1Q9oM3moBCKaTWDSS1QBsttYLVWu15Ht
# 1nfCQRtCLFXD1SsukStoGrz+o3akRMrI0A3qZsgpWOVV10D4NhWy35+/HyBNwlMK
# bf4pwLP+2H+Lxdf9GA7QrAbn3wRRpoEOeqwA2X8cACM5MNyMmCJ/yJts/8stRZbu
# XGWElt64KLZz4msPYPJTORblCxlKIOkgHDHYXWwt5J+J/7mW0dt2ixSuiKl0iOSw
# iR9Zk1yD7reyBTM0LzEOIKvDtr31vy5WE3E2LNJv6teqDPZ6Dhj8fUYMFJtoIOrD
# hWBNJgfpANhv5Zut2d28pc8lmyeAC/3CrF0fm0mM9laIU207b7o2mC0JfhJuqsf8
# aeUYu4O8o6Ms5nnLm421Dr2TKfvLYVn+cA9so7O1PCj1tKkpPvFFjyNs9HbkcD6p
# fOX2jA/Gz5JtClf1ZJgz8aZtunOQcVXU2AHswS3rI+zH/lgzux0LNtFN
