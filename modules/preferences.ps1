<#
.SYNOPSIS
  User preferences for the Fin PowerShell environment.
.DESCRIPTION
  This file allows you to customize the look, feel, and behavior of Fin.
  It is sourced by fin.ps1 on startup.
#>
...
$global:FinPreferences = @{
    ...
    # CustomGreeting = {
    #     Write-Host "My Custom Greeting!" -ForegroundColor Magenta
    #     sysinfo
    # }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxswWg49NmORyqxiIJ0CCrayR
# k7ugghZQMIIDEjCCAfqgAwIBAgIQdAYnD4MYrLRGhujoNt/icTANBgkqhkiG9w0B
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRYSMDYDU1O
# 00K7rLCzCcO78/C1JzANBgkqhkiG9w0BAQEFAASCAQBKkgnfcxzF39csDS4p8CiY
# YLn76cTd/aVYSNbRE6QL8q3u9j3ddanalS57gK4oWirkpGnLj/Ekbj7wB3fZbBLr
# P/DdfAwzxox30S1F8Q5j9+xvjD1dDeBfs6JB5vOAsaBcq/TtXPZf9VCsUjFc2hUy
# wykq9WWGbRh2nkdD+5fO+aNd8k1a920rWEdOLE7J1l8EezCR/M3K8nhZWHlYVByL
# +Yjoqz48WbyJrUPH7Onp/vitXB/MIdLiHMPtx9hJa2xiaKFeLzE/8UIrvwk1LZ5F
# l2DwSelOmXMsXVzirOxw7UJ0q8Z4g75S+5qkTGOwJshY9Wxen2pD822UCcieom3w
...
# AQkEMSIEIFHj5kEmnfH+4SL7tve+P7iR7Q1q5J0s0jMOo00vGrG8MA0GCSqGSIb3
# DQEBAQUABIICACCkPEtNsk18iO8o1tERI0/xj/YZqjGOTxzB80ToBdHCuHTnr2ia
# NQSeHad54VOId2mYaXecWduxoAltEzjXNoSsWDFR57f0suCMizAQGOmijK4qK+rQ
# a0FBDokox2kglsa33SppkHe2gT8my99IDQ2H2J+cNY0TkdJl0ye8hjCM8On+msGF
# JKsBzbD/k7b3Q99K++Fk7G2v7dcEeNSpl97UsBygOS1pwn7FmUZRHX6UOdSXD8Lk
# UQqHhvH7GOwfEedbNpl5lIy4gjOtEj+e5sXsUvwqZMIKmpRyBUUMCsHRg6vy2Zct
# Mq/OFdoxzzFkRVgtzj0O+8Ed3V+k1+/lEvIgCVx7SzZ9gYJZ0EFgL6f88Vi5apKI
# EdsVZklIQwdmuQRr/zj/Ll0I8LA43IAXPWHJSUBDHmy1Te9FTQCYxa4ZnRbwsuRY
# Yvd53rKLj5NzjuVCQSKs39ylnkGCkIT7vUmhlrrKXfD7dwaUbBEoVt2q5Sn6Q5sc
# V68OftI+q2EhIzl6+vR8VD5Z9IyUA4vKW7VqYYX76qo6JvtXUVIH0Kpo1HBx9i6b
# C65v7YNlNEIw1X7aRp7KWzv+6lD5pA/0N3m8+jBNa87wqzq7RCx3yg2rf7W8ocie
# uHBDM6EOpP9ZM2FRMggIUsNQCtKhSoDgBWaIXqwpNHeVCmAlMvcvEh3K
